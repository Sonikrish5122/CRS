  ...
  while ($data = mysqli_fetch_assoc($res)) {
    ...
    $table_data .= "
        <tr>
          ...
          <td>
          <button type='button' onclick='assign_car($data[booking_id])' class='btn text-white btn-sm fw-bold custom-bg shadow-none' data-bs-toggle='modal' data-bs-target='#assign-car' style='width: 150px; height: 40px;'>
              <i class='bi bi-check2-square'></i> Assign Car
          </button><br>
          
          <button type='button' onclick='cancel_booking($data[booking_id])' class='btn btn-outline-danger mt-2 btn-sm fw-bold shadow-none' style='width: 150px; height: 40px;'>
