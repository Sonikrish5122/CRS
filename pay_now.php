...
if (isset($_POST['pay_now'])) {
    ...
    if ($final['data']['instrumentResponse']['status'] === 'SUCCESS') {
        // Payment successful
    ...
    $query1 = "INSERT INTO `booking_order`(`user_id`, `car_id`, `booking_date`, `dropout_date`, `order_id`, `trans_amt`, `trans_resp_msg`, `trans_status`, `booking_status`, `trans_id`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    insert($query1, [
        $_SESSION['uId'],
        $_SESSION['car']['id'],
        ...
        $final['data']['instrumentResponse']['merchantTransactionId'] // Add the trans_id
    ], "isssssdsss");
